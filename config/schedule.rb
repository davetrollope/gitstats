...
every :hour, at: 45 do
  ...
  runner "require 'github_data_file'; GithubDataFile.get_user_prs 'archive', GithubDataFile.prefix_hour, 'django', state: 'open'"
end

every :hour, at: 50 do
  runner "require 'github_data_file'; GithubDataFile.get_consolidated_user_prs 'archive', GithubDataFile.prefix_today + '*_open_pr_data.json', GithubDataFile.prefix_today, 'django', state: 'open'"
end
...
every :day, at: '7:32 am' do
  runner "require 'github_data_file'; GithubDataFile.get_user_prs 'archive', GithubDataFile.prefix_today, 'django'"
end
